...
class Yb < Formula
  ...
  url "https://github.com/yourbase/yb/archive/v0.6.2.tar.gz"
  sha256 "65005463dc234a22e2595f9340cbe6151db556ab2e3a601a064298f01078f37e"
  license "Apache-2.0"
  ...
  def install
    ...
    ENV["GITHUB_SHA"] = "c4560ea9cfbc2d575b8db5b05b0c169f38298561"
    ENV["GO111MODULE"] = "on"
