...
class Yb < Formula
  ...
  url "https://github.com/yourbase/yb/archive/v0.6.1.tar.gz"
  sha256 "aad5d279300c0d5d6e0f4725deaf7798cf4dc449b2e874843179148524571266"
  license "Apache-2.0"
  ...
  def install
    ...
    ENV["GITHUB_SHA"] = "fe8b9f33e64b1c4fb644bea306eac62072ea95a2"
    ENV["GO111MODULE"] = "on"
